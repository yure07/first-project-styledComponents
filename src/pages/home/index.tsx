...
const Login:React.FC = () => {
  ...
  const [navigateAutheticated, setNavigateAutheticated] = useState<boolean>(false)
    ...
    <Main>
      <ContainerForm>
        ...
        <Form>
          ...
          <ButtonSubmit onClick={handleSubmit}> {navigateAutheticated ? (<Link to="/login">Entrar</Link>) : (<>Enrtrar</>)} </ButtonSubmit>
        </Form>
      </ContainerForm>
    </Main>
  );
